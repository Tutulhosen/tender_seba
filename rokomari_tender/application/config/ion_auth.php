...
*/
$config['tables']['users']           = 'ts_web_user';
 ...
 */
$config['site_title']                 = "rokomaritender.com";       // Site Title, example.com
$config['admin_email']                = "info@rokomaritender.com"; // Admin Email, admin@example.com

$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['invoice_group']              = 'generate_invoice';  // generate invoice group, use name
$config['stock_group']                = 'stock_manage';  	// insert product group, use name
$config['setup_group']                = 'setup_user';  		// setup user group, use name

$config['identity']                   = 'webu_email';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
$config['min_password_length']        = 8;                   // Minimum Required Length of Password
$config['max_password_length']        = 20;                  // Maximum Allowed Length of Password
$config['email_activation']           = TRUE;         // Email Activation for registration 25-02-18
 ...
 */
$config['use_ci_email'] = TRUE; // Send Email using the builtin CI email class, if false it will return the code and the identity 	//25-02-18 made it TRUE
...
$config['message_start_delimiter'] = '<div class="alert alert-success alert-dismissible"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> <i class="icon fa fa-check"></i> '; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> <i class="fa fa-warning"></i> ';		// Error message start delimiter
