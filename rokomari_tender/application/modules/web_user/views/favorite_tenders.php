...
<!-- <div class="filter  bg-warning py-3">
  <div class="container">
  <div class="row">
...
<div class="main_content container">
  ...
  <p class="h5 text-primary">Showing <span id="total_tender"><?= $size_of_fav_ten ?></span> Tender</p>
  ...
  <div class="row">
    ...
    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-xs-12">
      ...
      <?php
        if(empty($favorite_tenders))
          echo '<span style="color: red;">No Tender Found!</span>';
        
        foreach($favorite_tenders as $tenRow):
      ?>
        <div class="content-2" style="background-color: #f3f3f3; border:1px solid #dfdfdf;">
          <p class="h6 px-3 pt-3" id="tender_title<?= $tenRow->tender_auto_id ?>">
            <?= '<i class="fa fa-star" style="color: #ff0000;"></i> ' . $tenRow->tender_title ?>
          </p>
          <div class="text-justify px-3 py-1">
            ...
            <button class=" mx-2 btn float-right btn-sm border" id="favcaticon<?= $tenRow->tender_auto_id ?>" onclick="addorremvfavcat(<?= $tenRow->tender_auto_id ?>)" title="Remove from favorite" ><i class="fa fa-times" style="color: #ff0000;"></i></button>
