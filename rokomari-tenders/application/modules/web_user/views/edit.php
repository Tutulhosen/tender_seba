    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('web_user/add')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Add New User</a> 
        </div>        
        <?php echo form_open_multipart("web_user/edit/" . $web_user_details['webu_id']);?>
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <?php echo form_dropdown('webu_company_type', $webu_company_type, set_value('webu_company_type', $web_user_details['webu_company_type']), 'class="form-control select2" required');?>
                </div>
              </div>
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <?php 
                    ...
                    $wus_value = set_value('webu_status', $web_user_details['webu_status']);
                    $wus = $wus_value != '' ? $wus_value : 1;
                  ?>
                  </div>
          ...
          <div class="box-footer">    
            ...
            <?php echo form_submit('submit', 'Update User', "class='btn btn-primary pull-right'"); ?>
          </div>
        <?php echo form_close();?>
      </div>
      <!-- /.box -->
