...
<html lang="en">
  <head>
    ...
    <style type="text/css">
        ...
        .banner{
            background-image: url("<?= base_url() ?>assets/images/banner3.jpg");
            height: 300px;
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto pt-">
            <li class="nav-item active">
              <a class="nav-link text-primary active" href="<?= base_url() ?>" ><span class="badge badge-pill badge-primary px-3 py-2">Home </span><span class="sr-only">(current)</span></a>

            </li>
            <li class="nav-item">
              <a class="nav-link text-primary" href="<?= base_url('site/index/0/1') ?>">About us</a>
            </li>
            
            <li class="nav-item">
              <a class="text-primary nav-link disabled" href="<?= base_url('site/index/0/2') ?>">Services</a>
            </li>
            <li class="nav-item">
              <a class="text-primary nav-link" href="<?= base_url('site/index/0/3') ?>">How it works</a>
            </li>
            <li class="nav-item">
              <a class="text-primary nav-link" href="#">Pro</a>
            </li>
            <li class="nav-item">
              <a class="text-primary nav-link" href="#">Amenities</a>
            </li>
          </ul>
...
<!--         <div class="pt-5"></div>
        ...
        <div class="row justify-content-end text-center ">
          <div class="sm-3 bg-secondary">
            <p class="h6 text-light px-3 pt-3"> New Tender</p>
            <p class="h1 text-light"> <?= $stat_tender ?></p>
          </div>
          <div class="sm-3 bg-success">
            <p class="h6 text-light px-3 pt-3">Corrigendum</p>
            <p class="h1 text-light"> <?= $stat_corrigendum ?></p>
          </div>
          <div class="sm-3 bg-dark">
            <p class="h6 text-light px-3 pt-3">Cancellation</p>
            <p class="h1 text-light"> <?= $stat_cancellation ?></p>
          </div>
          <div class="sm-3 bg-warning">
            <p class="h6 text-light px-3 pt-3">Republished</p>
            <p class="h1 text-light"> <?= $stat_republished ?></p>
          </div>
