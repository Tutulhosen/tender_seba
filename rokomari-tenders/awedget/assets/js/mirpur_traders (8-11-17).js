...
// {
// 	//11-10-17
// 	r = confirm('Delete this company?');
// 	if( r == true)
// 	{
// 		$.ajax({
// 			type: "POST",
// 			url: $('#delete_company_url').val(),
// 			data: { company_id : id},
...
// {
// 	//11-10-17
// 	r = confirm('Delete this country?');
// 	if( r == true)
// 	{
// 		$.ajax({
// 			type: "POST",
// 			url: $('#delete_country_url').val(),
// 			data: { country_id : id},
// 			success: function(data)
// 			{
// 				alert(data);
...
// {
// 	//12-10-17
// 	r = confirm('Delete this Sub Category?');
// 	if( r == true)
// 	{
// 		$.ajax({
// 			type: "POST",
// 			url: $('#delete_subcategory_url').val(),
// 			data: { sub_cat_id : id},
// 			success: function(data)
// 			{
// 				alert(data);
