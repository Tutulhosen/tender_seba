...
--
-- Host: localhost
-- Generation Time: Oct 09, 2023 at 12:03 PM
...
CREATE TABLE `ts_feedbacks` (
  ...
  `webu_id` int NOT NULL,
  `feedback_subject` varchar(150) NOT NULL,
  `feedback_description` text NOT NULL,
  `feedback_seen` int NOT NULL DEFAULT '1' COMMENT '1 = Unseen, 2 = Seen',
...
CREATE TABLE `ts_feedback_answers` (
  ...
  `feedback_id` int NOT NULL,
  `answer_from` int NOT NULL COMMENT '1 = User, 2 = From Us',
...
CREATE TABLE `ts_packages` (
  ...
  `pkg_duration` varchar(30) DEFAULT NULL,
  `pkg_no_of_products` int DEFAULT NULL,
  `pkg_price` int DEFAULT NULL,
  `pkg_description` text,
  `pkg_logo_path` varchar(180) DEFAULT NULL,
  `pkg_created` datetime DEFAULT NULL,
  `pkg_updated` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ts_packages` (`pkg_id`, `pkg_name`, `pkg_duration`, `pkg_no_of_products`, `pkg_price`, `pkg_description`, `pkg_logo_path`, `pkg_created`, `pkg_updated`) VALUES
(1, 'Silver', '40', 20, 50, 'The Silver udated', 'http://localhost/tenderSeba/rokomari-tenders/assets/icon/RocketLaunch.svg', '2023-03-12 16:24:04', '2023-09-14 09:13:43'),
(2, 'Gold', '20', 41, 100, 'Gold\r\n', 'http://localhost/tenderSeba/images/pkg/2_1678786124.png', '2023-03-12 18:07:39', '2023-09-14 09:13:37'),
(3, 'Platinam', '30', 12, 150, 'Platinam\r\n', 'http://localhost/tenderSeba/images/pkg/3_1678786141.png', '2023-03-12 18:33:48', '2023-09-13 10:35:54'),
(4, 'Free', '15', 10, 0, 'Free Package', 'http://localhost/tenderSeba/images/pkg/4_1694321830.png', '2023-03-14 16:02:26', '2023-09-14 09:13:32');
...
CREATE TABLE `ts_payment_history` (
  ...
  `payment_by` int NOT NULL COMMENT '1 = Bkash, 2 = Bank, 3 = Cash',
...
CREATE TABLE `ts_tariffs` (
  ...
  `tariff_duration` int NOT NULL,
  `tariff_month_year` int NOT NULL COMMENT '1 = Month, 2 = Year',
  `tariff_amount` int NOT NULL,
  `tariff_remarks` varchar(255) NOT NULL,
  `tariff_bd_overseas` int NOT NULL COMMENT '1 = BD, 2 = Overseas',
  `tariff_status` int NOT NULL COMMENT '1 = Active, 2 = Deactive',
...
CREATE TABLE `ts_tenders` (
  ...
  `tender_inviter` int NOT NULL,
  `tender_source` int NOT NULL,
  `tender_division` int NOT NULL,
  `tender_district` int NOT NULL,
  `tender_procuring_div` int DEFAULT NULL,
  `tender_procuring_dist` int DEFAULT NULL,
  `tender_category` int NOT NULL,
  `tender_sub_category` int NOT NULL,
  `tender_pro_method` int NOT NULL,
  `tender_call_type` int NOT NULL COMMENT '1 = Tender, 2 = Corrigendum, 3 = Cancellation, 4 = republished',
  `tender_on` int NOT NULL COMMENT '1 = Goods, 2 = Works, 3 = Services',
  `tender_bidding_type` int NOT NULL COMMENT '1 = Local, 2 = International',
  `tender_img_url` varchar(255) NOT NULL,
  `tender_view` int NOT NULL,
...
INSERT INTO `ts_tenders` (`tender_auto_id`, `tender_title`, `tender_description`, `tender_manual_id`, `tender_doc_price`, `tender_security_amount`, `tender_published_on`, `tender_closed_on`, `tender_closed_time`, `tender_prebid_meeting`, `tender_opening`, `tender_opening_time`, `tender_schedule_purchase`, `tender_sche_pur_time`, `tender_inviter`, `tender_source`, `tender_division`, `tender_district`, `tender_procuring_div`, `tender_procuring_dist`, `tender_category`, `tender_sub_category`, `tender_pro_method`, `tender_call_type`, `tender_on`, `tender_bidding_type`, `tender_img_url`, `tender_view`, `tender_created`, `tender_updated`) VALUES
(25, 'Invitation for supply of back pack brush cutter, grass-cutter machine, installation.', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000001', 'See image for detail', 'See image for details', '2018-03-01', '2018-03-29', '12:00 PM', '2018-03-15', NULL, NULL, '2018-03-04', NULL, 60, 4, 5, 5, NULL, NULL, 30, 294, 1, 2, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/25.jpg', 0, '2018-03-05 18:40:00', '2023-09-06 08:27:33'),
(26, 'Invitation for making of assault course ground', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000002', 'See image for detail', 'See image for details', '2018-03-01', '2018-03-02', '12:00 pm', '2018-03-06', NULL, NULL, '2018-03-04', NULL, 4, 4, 6, 11, NULL, NULL, 15, 25, 2, 3, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/26.jpg', 1, '2018-03-05 18:48:59', '2023-09-06 08:27:44'),
(27, 'Invitation for construction, improvement of palisading, classroom, barbed-fencing-work, stage, culvert, boundary-wall, installation of deep-tube-well, guide-wall, supply of sewing-machine, bicycle', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000003', 'See image for detail', 'See image for details', '2018-03-03', '2018-03-04', '12:00 am', '2018-03-04', '2018-03-10', NULL, '2018-03-06', NULL, 5, 5, 7, 23, NULL, NULL, 17, 59, 4, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/27.jpg', 0, '2018-03-05 18:51:09', '2023-09-06 08:27:52'),
(28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender) upd', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000004.2', 'See image for detail updated', 'See image for details updated new', '2018-03-07', '2018-03-09', '01:00 pm', '2018-03-10', '2023-01-05', '', '2023-02-05', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/28_1688902898.png', 7, '2018-03-05 18:58:26', '2023-09-06 08:28:02'),
(29, 'Invitation for construction of memorial plate and building (3 Lots)', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000005', 'Tk 400 per lot', 'Tk 7500, 11500, 12500 respectively', '2018-03-25', '2018-04-07', '12:16 pm', '2018-05-05', '1970-01-01', '', '1970-01-01', '', 4, 4, 5, 5, 0, 0, 15, 25, 1, 1, 1, 1, '', 0, '2018-03-05 19:02:30', '2023-07-19 03:44:49'),
(30, 'Auction for sales of properties', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000006', 'See image for detail', 'See image for details', '2018-03-13', '2018-03-15', '12:00 pm', '2018-03-13', NULL, NULL, NULL, NULL, 5, 47, 11, 53, NULL, NULL, 18, 82, 4, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/30.jpg', 1, '2018-03-01 19:19:41', '2023-09-06 08:28:10'),
(31, 'Auction for sales of properties1', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000007', 'See image for detail', 'See image for details', '2018-03-18', '2018-03-19', '10:00 AM', '2018-03-20', NULL, NULL, NULL, NULL, 6, 7, 9, 41, NULL, NULL, 19, 102, 5, 2, 2, 2, 'http://tender-seba.mysoftheaven.com/images/tender/31.jpg', 1, '2018-03-01 19:22:22', '2023-09-06 08:28:19'),
(32, 'Request for Proposal (RFP) for making of manuscript', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000008', 'See image for detail', 'See image for details', '2018-03-19', '2018-03-29', '12:00 pm', '2018-03-21', NULL, NULL, NULL, NULL, 8, 9, 5, 6, NULL, NULL, 15, 26, 1, 3, 3, 1, 'http://tender-seba.mysoftheaven.com/images/tender/32.jpg', 5, '2018-03-01 19:24:41', '2023-09-06 08:28:31'),
(33, 'Corrigendum notice (amendment made on this tender has been running in second slot again)', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000009', '313tk', 'See image for details', '2018-01-24', '2018-02-27', '12:00 pm', '2018-03-20', NULL, NULL, NULL, NULL, 43, 6, 10, 52, NULL, NULL, 24, 202, 7, 2, 2, 2, 'http://tender-seba.mysoftheaven.com/images/tender/33.jpg', 1, '2018-03-01 19:45:02', '2023-09-06 08:28:36'),
(34, 'Invitation for painting, lettering of KM-post of bridge culvert railing post parapet wall guide post, reconstruction of culvert, palisading, earth-filling, supply, filling of bats and local sand for repairing of damaged pavement (e-Tender)', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000010', 'See image for details', 'See image for details', '2018-03-04', '2018-03-05', '12:16 pm', '2018-03-06', '2018-03-07', '10:00 am', '2018-03-08', '03:00 pm', 7, 4, 5, 9, NULL, NULL, 20, 115, 1, 4, 1, 2, 'http://tender-seba.mysoftheaven.com/images/tender/34.jpg', 21, '2018-03-05 18:53:47', '2023-09-06 08:28:42'),
(35, 'Test Tender 1', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '0000000100', '966666', '96999', '2023-02-28', '2023-03-11', '12:99 PM', '2023-02-14', '2023-03-06', '11:99 PM', '2023-03-07', '11:99 PM', 5, 6, 11, 63, 11, 63, 15, 25, 2, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/35.jpg', 1, '2023-02-22 15:54:16', '2023-09-06 08:29:56'),
(36, 'Test Tender 2', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '000000016', '150000', '1500', '2023-05-17', '2023-10-28', '12:59 PM', '2023-08-03', '2023-08-05', '09:00 AM', '2023-08-01', '11:15 AM', 4, 4, 7, 23, 7, 23, 15, 25, 1, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/36_1688903201.png', 0, '2023-07-09 17:46:41', '2023-09-06 08:30:03'),
(37, 'Agriculter Terder 23', 'Invitation for supply of consumables, health item, ration-item, machineries, tools, furniture, surgical-items, medical-equipments, tailoring-works of dress, ribon, name-plate, labor, spare-parts of vehicle, transportation, computer-accessories, laundry-works', '00000002302', '125555', '125', '2023-07-08', '2023-09-29', '12:00 PM', '2023-08-02', '2023-08-03', '11:00 PM', '2023-08-05', '11:00 PM', 4, 4, 6, 11, 6, 14, 19, 103, 1, 1, 1, 1, 'http://tender-seba.mysoftheaven.com/images/tender/37_1688903548.png', 0, '2023-07-09 17:52:28', '2023-09-06 08:30:09');

-- --------------------------------------------------------

--
-- Table structure for table `ts_tenders_updated`
--

CREATE TABLE `ts_tenders_updated` (
  `tender_updated_id` int NOT NULL,
  `tender_parent_id` int NOT NULL,
  `tender_title` text NOT NULL,
  `tender_description` text,
  `tender_manual_id` varchar(20) NOT NULL,
  `tender_doc_price` varchar(100) NOT NULL,
...
--
-- Dumping data for table `ts_tenders_updated`
--

INSERT INTO `ts_tenders_updated` (`tender_updated_id`, `tender_parent_id`, `tender_title`, `tender_description`, `tender_manual_id`, `tender_doc_price`, `tender_security_amount`, `tender_published_on`, `tender_closed_on`, `tender_closed_time`, `tender_prebid_meeting`, `tender_opening`, `tender_opening_time`, `tender_schedule_purchase`, `tender_sche_pur_time`, `tender_inviter`, `tender_source`, `tender_division`, `tender_district`, `tender_procuring_div`, `tender_procuring_dist`, `tender_category`, `tender_sub_category`, `tender_pro_method`, `tender_call_type`, `tender_on`, `tender_bidding_type`, `tender_img_url`, `tender_view`, `tender_created`, `tender_updated`) VALUES
(2, 35, 'Test Tender 1', NULL, '0000000100', '966666', '96999', '2023-02-28', '2023-03-11', '12:99 PM', '2023-02-14', '2023-03-06', '11:99 PM', '2023-03-07', '11:99 PM', 5, 6, 11, 63, 11, 63, 15, 25, 2, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/35.png', 0, '0000-00-00 00:00:00', '2023-02-22 10:31:52'),
(3, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender)', NULL, '0000000004.1', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-08', '12:00 pm', '2018-03-09', '1970-01-01', '', '1970-01-01', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28.jpg', 0, '0000-00-00 00:00:00', '2023-02-22 10:33:51'),
(4, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender)', NULL, '0000000004', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-08', '12:00 pm', '2018-03-09', '1970-01-01', '', '1970-01-01', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28.png', 0, '0000-00-00 00:00:00', '2023-02-22 10:38:54'),
(5, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender)', NULL, '0000000004', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-08', '12:00 pm', '2018-03-09', '1970-01-01', '', '1970-01-01', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677062334.jpg', 0, '0000-00-00 00:00:00', '2023-02-22 10:40:48'),
(6, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender)', NULL, '0000000004', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-08', '12:00 pm', '2018-03-09', '2023-01-04', '', '2023-02-04', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677062448.jpg', 0, '0000-00-00 00:00:00', '2023-02-22 10:43:44'),
(7, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender)', NULL, '0000000004', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-08', '12:00 pm', '2018-03-09', '2023-01-04', '', '2023-02-04', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677062624.jpg', 0, '0000-00-00 00:00:00', '2023-02-22 11:02:38'),
(8, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender) ', NULL, '0000000004.1', 'See image for detail', 'See image for details updated', '2018-03-07', '2018-03-09', '01:00 pm', '2018-03-10', '2023-01-05', '', '2023-02-05', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677063758.png', 0, '0000-00-00 00:00:00', '2023-02-23 08:32:15'),
(9, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender) upd', NULL, '0000000004.2', 'See image for detail updated', 'See image for details updated new', '2018-03-07', '2018-03-09', '01:00 pm', '2018-03-10', '2023-01-05', '', '2023-02-05', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677063758.png', 0, '0000-00-00 00:00:00', '2023-07-09 11:41:18'),
(10, 28, 'Invitation for construction of monument and repair, alternation & maintenance of hospital (e-Tender) upd', NULL, '0000000004.2', 'See image for detail updated', 'See image for details updated new', '2018-03-07', '2018-03-09', '01:00 pm', '2018-03-10', '2023-01-05', '', '2023-02-05', '', 4, 4, 11, 63, 11, 63, 18, 77, 9, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/28_1677063758.png', 0, '0000-00-00 00:00:00', '2023-07-09 11:41:38'),
(11, 35, 'Test Tender 1', NULL, '0000000100', '966666', '96999', '2023-02-28', '2023-03-11', '12:99 PM', '2023-02-14', '2023-03-06', '11:99 PM', '2023-03-07', '11:99 PM', 5, 6, 11, 63, 11, 63, 15, 25, 2, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/35.jpg', 0, '0000-00-00 00:00:00', '2023-07-18 07:19:15'),
(12, 35, 'Test Tender 1', NULL, '0000000100', '966666', '96999', '2023-02-28', '2023-03-11', '12:99 PM', '2023-02-14', '2023-03-06', '11:99 PM', '2023-03-07', '11:99 PM', 5, 6, 11, 63, 11, 63, 15, 25, 2, 1, 1, 1, 'http://localhost/tenderSeba/images/tender/35.jpg', 0, '0000-00-00 00:00:00', '2023-09-06 08:25:45');
...
CREATE TABLE `ts_user_cat_list` (
  ...
  `ucat_user_id` int NOT NULL,
  `ucat_sub_cat_id` int NOT NULL,
...
(23, 43, 25, '2023-09-19 08:55:46'),
(24, 43, 26, '2023-09-19 08:55:46'),
(25, 43, 27, '2023-09-19 08:59:29'),
(26, 43, 28, '2023-09-19 08:59:29'),
(27, 43, 59, '2023-09-19 09:15:50'),
(35, 60, 25, '2023-09-25 04:27:00'),
(36, 60, 26, '2023-09-25 04:27:00'),
(37, 60, 27, '2023-09-25 04:27:00'),
(38, 60, 29, '2023-09-25 04:27:00'),
(39, 60, 31, '2023-09-25 04:27:00');
...
CREATE TABLE `ts_user_fav_ten_list` (
  `ufav_id` int NOT NULL,
  `ufav_user_id` int NOT NULL,
  `ufav_tender_id` int DEFAULT NULL,
  `save_tender_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
INSERT INTO `ts_user_fav_ten_list` (`ufav_id`, `ufav_user_id`, `ufav_tender_id`, `save_tender_id`, `ufav_created`) VALUES
(2, 43, NULL, '[\"27\",\"26\"]', '2023-09-19 09:31:01'),
(4, 60, NULL, '[\"26\"]', '2023-09-25 09:59:46');

-- --------------------------------------------------------

--
-- Table structure for table `ts_user_pkg_list`
--

CREATE TABLE `ts_user_pkg_list` (
  `upkg_id` int NOT NULL,
  `upkg_user_id` int NOT NULL,
  `upkg_pkg_id` int DEFAULT NULL,
  `upkg_created_at` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ts_user_pkg_list`
--

INSERT INTO `ts_user_pkg_list` (`upkg_id`, `upkg_user_id`, `upkg_pkg_id`, `upkg_created_at`) VALUES
(6, 43, 1, '2023-09-19'),
(9, 60, 2, '2023-09-25');
...
CREATE TABLE `ts_web_user` (
  ...
  `webu_full_name` varchar(100) DEFAULT NULL,
  ...
  `webu_status` int DEFAULT NULL COMMENT '1 = Active, 2 = Deactive',
  `webu_email` varchar(70) DEFAULT NULL,
  `webu_phone` varchar(20) DEFAULT NULL,
  `webu_web_access` int DEFAULT NULL COMMENT '1 = Running, 2 = Suspend',
  `webu_web_acc_exp` date DEFAULT NULL,
  `webu_email_alert` int DEFAULT NULL COMMENT '1 = Running, 2 = Suspend',
  `webu_email_al_exp` date DEFAULT NULL,
  `webu_sms_alert` int DEFAULT NULL COMMENT '1 = Running, 2 = Suspend',
  `webu_sms_al_exp` date DEFAULT NULL,
  `webu_auto_reminder` int DEFAULT NULL COMMENT '1 = Running, 2 = Suspend',
  `webu_auto_re_exp` date DEFAULT NULL,
  `webu_company_name` varchar(150) DEFAULT NULL,
  `webu_designation` varchar(100) DEFAULT NULL,
  `webu_company_type` int DEFAULT NULL,
  `webu_company_address` varchar(255) DEFAULT NULL,
  `webu_website` varchar(255) DEFAULT NULL,
  `webu_created` datetime DEFAULT NULL,
...
INSERT INTO `ts_web_user` (`webu_id`, `ip_address`, `webu_full_name`, `password`, `salt`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `last_login`, `activation_code`, `email_otp`, `created_on`, `webu_status`, `webu_email`, `webu_phone`, `webu_web_access`, `webu_web_acc_exp`, `webu_email_alert`, `webu_email_al_exp`, `webu_sms_alert`, `webu_sms_al_exp`, `webu_auto_reminder`, `webu_auto_re_exp`, `webu_company_name`, `webu_designation`, `webu_company_type`, `webu_company_address`, `webu_website`, `webu_created`, `webu_updated`) VALUES
(43, '202.133.91.102', 'Ismail', '$2y$08$wCRQw4BNt.hd1R/2J7SVyOnIIIxDXz5ghNothRy5VMp2ncvbo4nQu', NULL, NULL, NULL, NULL, 1695644777, '', NULL, 1519908399, 1, 'ismail13hossen@gmail.com', '01671397450', 0, '0000-00-00', 1, '2018-03-31', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2018-03-01 18:46:39', '2023-09-25 12:26:17'),
(44, '103.222.22.141', 'Pollob', '$2y$08$S83/Gpe/apLv4KesJB7zE.l2YxvLUOwaC1hHBv8TtBc/bY0.flCOC', NULL, NULL, NULL, NULL, NULL, '', NULL, 1520258779, 1, 'pollob8@gmail.com', '01671397451', 0, '0000-00-00', 1, '2018-03-31', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2018-03-05 20:06:19', '2018-03-05 14:07:01'),
(45, '202.133.91.102', 'araf', '$2y$08$z1rqVsVg0Zwfs2Gf6bpqKOXNsyq/OhSqO65NumsyOgvIDYmDZVkvy', NULL, 'w1b-JDlTx3GIaEbJMrE2weeaa282344ed53223f4', 1576037116, NULL, NULL, 'a6bc6782c8caafd137f2916c45f934ddf307bc41', NULL, 1523187049, 0, 'araf@gmail.com', '01671397454', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2018-04-08 17:30:49', '2019-12-11 04:05:16'),
(46, '202.133.91.102', 'kaoser', '$2y$08$mMTKoP0DE456uTo7.esxjeb48vZc/m9AusN9pAkuoIqffJQBbAp7q', NULL, NULL, NULL, NULL, 1576036956, '', NULL, 1575945661, 1, 'kaosermahmud.cse@gmail.com', '01845845486', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2019-12-10 08:41:01', '2019-12-11 04:02:36'),
(47, '202.133.91.102', '', '$2y$08$8nrwhmj8ZFeHMe.WLl6QSuZEj/2PnefT0EuzIRzJhQku8czo7is1W', NULL, NULL, NULL, NULL, 1576042092, '', NULL, 1576041295, 1, 'kaosermahmud.cse@gmail.com', NULL, 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2019-12-11 11:14:55', '2023-03-07 10:24:30'),
(48, '202.133.91.102', '', '$2y$08$4QEXoP68iPwSQ6ODIUwd3uR8v.vscaykVJkOfUuwKrAOmKmhbyEPG', NULL, NULL, NULL, NULL, 1576041458, '', NULL, 1576041396, 1, 'kaosermahmud111@gmail.com', NULL, 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2019-12-11 11:16:36', '2023-03-07 10:24:37'),
(49, '114.130.119.110', 'Khalid', '$2y$08$gtr8uGTLrMAbN8Er58VUqeK8JGnGAqhdImxQLD9t2rC9PR/S52gUu', NULL, NULL, NULL, NULL, NULL, '451add36787c90da2a0b7c4794baa56276fef21b', NULL, 1671614259, 0, 'khalid@gmail.com', '01689322376', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', '', '', 0, '', '', '2022-12-21 15:17:39', '2022-12-21 09:17:39'),
(54, '127.0.0.1', 'A. B. M. Touhidul Islam', '$2y$08$FVa7wA8VVQt2P1ZfYLYSbeWWlZPs/Bh5jm.ruKkHN1i4yGrU7DxVq', NULL, NULL, NULL, NULL, 1683018058, NULL, NULL, 1678529827, 1, 'touhidul.mysoftheaven@gmail.com', '01741315099', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-03-11 16:17:07', '2023-05-02 09:00:58'),
(57, NULL, 'ABM touhid2', '$2y$08$NbKJvIpPR0ZsXZwEOhX5ZOrGOZ1Rq.Ir1gJY78YurRmNf7A5geXHq', NULL, NULL, NULL, NULL, NULL, NULL, '8741881', NULL, NULL, 'touhidul.encoderit@gmail.com', '01683791964', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-03 04:01:13'),
(59, '103.239.255.216', 'touhidul', '$2y$08$30gwOFepH2pzgMMwCRHi5eM5N1vgJaVNH/whGuDOGL6mQkkPUtuF6', NULL, NULL, NULL, NULL, 1693990393, NULL, NULL, 1693989716, 1, 'touhidul.samadhan.solution@gmail.com', '01748890748', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-09-06 14:41:56', '2023-09-06 08:53:13'),
(60, '103.239.255.216', 'Tutul', '$2y$08$jOXqKou5tDirHP54pGGhkuh6Nc9BWS1DV5zU0Aw.LVSSvZdhXYsPG', NULL, NULL, NULL, NULL, 1695634651, NULL, NULL, 1695614330, 1, 'tutulhosen2022@gmail.com', '01551678133', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-09-25 09:58:50', '2023-09-25 09:37:31');
...
(1, '127.0.0.1', 'administrator', '$2y$08$7G9a1dqcBsczIU71PfjC1.CzkObDQpU5mXk9QL41e3Ach1IfYRl4i', '', 'administrator@gmail.com', NULL, NULL, '5Blh.PxSoRMYy1QEGejR3O', 1496699848, 1695300077, 1, 'Rafiq 1', 'Ahmed', '', '', '', '0000-00-00'),
...
--
-- Indexes for table `ts_tenders_updated`
--
ALTER TABLE `ts_tenders_updated`
  ADD PRIMARY KEY (`tender_updated_id`);
...
--
-- Indexes for table `ts_user_pkg_list`
--
ALTER TABLE `ts_user_pkg_list`
  ADD PRIMARY KEY (`upkg_id`);
...
--
ALTER TABLE `ts_districts`
  MODIFY `district_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT for table `ts_divisions`
--
ALTER TABLE `ts_divisions`
  MODIFY `division_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `ts_inviters`
  MODIFY `inviter_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `ts_packages`
--
ALTER TABLE `ts_packages`
  MODIFY `pkg_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ts_procurement_methods`
  MODIFY `pro_method_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `ts_sources`
--
ALTER TABLE `ts_sources`
  MODIFY `source_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `ts_sub_categories`
--
ALTER TABLE `ts_sub_categories`
  MODIFY `sub_cat_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;

--
-- AUTO_INCREMENT for table `ts_tariffs`
--
ALTER TABLE `ts_tariffs`
  MODIFY `tariff_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ts_tenders`
--
ALTER TABLE `ts_tenders`
  MODIFY `tender_auto_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `ts_tenders_updated`
--
ALTER TABLE `ts_tenders_updated`
  MODIFY `tender_updated_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ts_user_cat_list`
--
ALTER TABLE `ts_user_cat_list`
  MODIFY `ucat_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `ts_user_fav_ten_list`
--
ALTER TABLE `ts_user_fav_ten_list`
  MODIFY `ufav_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ts_user_pkg_list`
--
ALTER TABLE `ts_user_pkg_list`
  MODIFY `upkg_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `ts_web_user`
--
ALTER TABLE `ts_web_user`
  MODIFY `webu_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
