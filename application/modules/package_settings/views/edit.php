  ...
  <div class="row">
    <div class="col-md-6">
      <div class="box box-primary">
        ...
        <?php echo form_open_multipart("package_settings/edit/" . $package_details['pkg_id']);?>
          <div class="box-body">
            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <img src="<?=$package_details['pkg_logo_path'];?>" id="tender_image_pre" alt="No Image" height="170" width="240" style="border: 1px solid rgb(60, 141, 188);" >
                    </div>
                  </div>
                </div>
          </div>
          ...
          <div class="box-footer">    
            ...
            <?php echo form_submit('submit', 'Update Package', "class='btn btn-primary pull-right'"); ?>
          </div>
        <?php echo form_close();?>
      </div>
      <!-- /.box -->
