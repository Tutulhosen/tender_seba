  ...
  <div class="row">
    <div class="col-md-7">
      <div class="box box-primary">
        ...
        <?php echo form_open_multipart("inviter/add");?>
          <div class="box-body">
              ...
              <div class="col-md-12">
                  ...
                  <div class="radio">
                    ...
                    <?php 
                      ...
                      $sv = set_value('inviter_type') != '' ? set_value('inviter_type') : 1 ;
                    ?>
                    </div>
          ...
          <div class="box-footer">    
            ...
            <?php echo form_submit('submit', 'Create Inviter', "class='btn btn-primary pull-right'"); ?>
          </div>
        <?php echo form_close();?>
      </div>
      <!-- /.box -->
