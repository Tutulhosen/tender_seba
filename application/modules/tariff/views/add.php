  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box box-primary">
        ...
        <?php echo form_open_multipart("tariff/add");?>
          <div class="box-body">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <?php 
                    ...
                    $tmy = set_value('tariff_month_year') == '' ? 1 : set_value('tariff_month_year');
                  ?>
                  </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <?php 
                    ...
                    $tmy = set_value('tariff_bd_overseas') == '' ? 1 : set_value('tariff_bd_overseas');
                  ?>
                  </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <?php 
                    ...
                    $tst = set_value('tariff_status') == '' ? 1 : set_value('tariff_status');
                  ?>
                  </div>
          ...
          <div class="box-footer">    
            ...
            <?php echo form_submit('submit', 'Create Tariff', "class='btn btn-primary pull-right'"); ?>
          </div>
        <?php echo form_close();?>
      </div>
      <!-- /.box -->
