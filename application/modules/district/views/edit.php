  ...
  <div class="row">
    <div class="col-md-7">
      <div class="box box-primary">
        ...
        <?php echo form_open_multipart("district/edit/" . $district_details['district_id']);?>
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <?php echo form_dropdown('division_id', $divisions, set_value('division_id', $district_details['division_id']), 'class="form-control" required');?>
                  </div>
          ...
          <div class="box-footer">    
            ...
            <?php echo form_submit('submit', 'Update District', "class='btn btn-primary pull-right'"); ?>
          </div>
        <?php echo form_close();?>
      </div>
      <!-- /.box -->
