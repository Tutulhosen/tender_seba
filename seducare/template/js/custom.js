            ...
            success: function (response) {
                ...
                if (response.flag === "1") {
                    if (appointment_form === "sidebar") {
                        ...
                        $('.side-error .alert').remove();
                        $('.side-error').append('<div class="alert alert-danger" role="alert">Please enter ' + response.error + ' ! ! !</div>');
                    } else {
                        $('.make-appointment').button('reset');
                        $('.appointment-error .alert').remove();
                        $('.appointment-error').append('<div class="alert alert-danger" role="alert">Please enter ' + response.error + ' ! ! !</div>');
                    }
                } else {
                    if (appointment_form === "sidebar") {
                        $('.side-appointment').attr("disabled", true);
                        $('.side-error .alert').remove();
                        $('.side-error').append('<div class="alert alert-success" role="alert">Request Send Successfully.</div>');
                    } else {
                        $('.make-appointment').attr("disabled", true);
                        $('.appointment-error .alert').remove();
                        $('.appointment-error').append('<div class="alert alert-success" role="alert">Request Send Successfully.</div>');
                    }
                }
            }
        });
